    ...
    return (
        <div class="h-full bg-gray-50">
            <div class="p-8 space-y-6">
                ...
                <div class="space-y-4">
                    <div
                        class="flex items-center justify-between bg-white h-[60px] px-4 rounded-lg border border-gray-200">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input
                                ...
                                onChange$={(e) => onSettingsChange$({showStandardName: (e.target as HTMLInputElement).checked})}
                                class="sr-only peer"
                            />
                            <div
                                class="w-12 h-6 bg-gray-200 rounded-full peer peer-checked:after:translate-x-full peer-checked:bg-blue-600 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"/>
                        </label>
                    </div>
                    ...
                    <div
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input
                                ...
                                onChange$={(e) => onSettingsChange$({showImage: (e.target as HTMLInputElement).checked})}
                                class="sr-only peer"
                            />
                            <div
                                class="w-12 h-6 bg-gray-200 rounded-full peer peer-checked:after:translate-x-full peer-checked:bg-blue-600 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"/>
