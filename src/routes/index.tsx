...
import {dinStandards, imperialThreadSizes, metricThreadSizes} from '~/constants/hardware';
...
export default component$(() => {
    ...
    const generatePreview$ = $(async () => {
        if (!threadSize.value || !hardwareStandard.value || (selectedType.value === 'Screw' && !length.value)) {
            return;
        }

        const standard = dinStandards[selectedType.value.toLowerCase() as keyof typeof dinStandards]
        ...
        <div class="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 p-4">
            <div class="max-w-5xl mx-auto space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="lg:col-span-2 p-4 lg:p-8 space-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                <ThreadSizeDropdown
                                    ...
                                    options={selectedSystem.value === "Metric" ? metricThreadSizes : imperialThreadSizes}
                                ...
                                {selectedType.value === "Screw" ? (
                                    <input
                                        type="text"
                                        required
                                        placeholder={selectedSystem.value === "Metric" ? "Length (e.g., 10)" : "Length (e.g., 3/8″)"}
                            ...
                            <SearchableDropdown
                                ...
                                options={dinStandards[selectedType.value.toLowerCase() as keyof typeof dinStandards]}
                    ...
                    ${threadSize.value && hardwareStandard.value && (selectedType.value !== 'Screw' || length.value)
                                        ? 'bg-blue-600 text-white hover:bg-blue-700'
                                        : 'bg-gray-100 text-gray-400 cursor-not-allowed'}
                  `}
                                    onClick$={handleDownload$}
                                    disabled={!threadSize.value || !hardwareStandard.value || (selectedType.value === 'Screw' && !length.value)}
                                >
                                    <DownloadIcon/>
                                    <span>Download</span>
                                </button>
