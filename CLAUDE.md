...
6. **Git Workflow**:
   ...
   - Commit messages should NOT include "Generated by Claude" or any AI attribution
   - Feature branches should be named with prefix (e.g., feature/feature-name)
   - Bug fix branches should be named with prefix (e.g., fix/bug-name)
